...
image_path = os.path.join(dir_path, "bike.png")

# Check if the image exists
if os.path.exists(image_path):
    # Add image at the center above the title
    st.image(image_path, use_container_width=True)  # Updated parameter

    # Add the same image to the sidebar
    st.sidebar.image(image_path, use_container_width=True)  # Updated parameter
else:
    st.error("Image file 'bike.png' not found! Please check the file path.")
